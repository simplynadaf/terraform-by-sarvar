# Terraform Series - Article URLs Tracker
...
- **Status:** ✅ Published
- **dev.to URL:** https://dev.to/aws-builders/why-every-developer-should-learn-terraform-in-2026-and-how-to-start--4fk0
...
- **Status:** ✅ Published
- **dev.to URL:** https://dev.to/aws-builders/installing-terraform-and-setting-up-your-environment-1j9b
- **Published Date:** 2026-03-14
- **Local Path:** `articles/02-installation/article.md`
- **Word Count:** ~5,000 words
- **Reading Time:** 15-20 minutes

### Article 3: Your First AWS Resource
- **Title:** Your First Infrastructure as Code in Four Commands
- **Status:** ✅ Published
- **dev.to URL:** https://dev.to/aws-builders/your-first-infrastructure-as-code-in-four-commands-46ep
- **Published Date:** 2026-03-17
- **Local Path:** `articles/03-first-resource/article.md`
...
- **Series URL:** https://dev.to/sarvar_04/series/36963
- **GitHub Repo:** https://github.com/simplynadaf/terraform-by-sarvar
- **Author:** Sarvar Nadaf (@sarvar_04)

---

## Update Instructions

When you publish an article, update this file with:
1. dev.to URL
2. Published date
...
### Article 1: Introduction to Terraform & IaC
- **Status:** ✅ Published
- **dev.to URL:** https://dev.to/sarvar_04/article-slug-here
